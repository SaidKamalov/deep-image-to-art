from UGATIT_Original import UGATIT
from UGATIT_NoCycleLoss import UGATIT_NoCycleLoss
import argparse
from utils import *
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='landscape2cubism', help='dataset_name')
